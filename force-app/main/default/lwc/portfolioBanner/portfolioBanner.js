...
export default class PortfolioBanner extends LightningElement {
    linkedinUrl = 'https://www.linkedin.com/in/saurabh-bisht-953816174/'
    githubUrl = 'https://github.com/saurabhb29'
    youtubeUrl = 'https://www.youtube.com/@SaurabhBishtVlogs-li7qr'
    trailheadUrl = 'https://www.salesforce.com/trailblazer/sbdeveloper'

    userPic = `${PortfolioAssets}/PortfolioAssets/SaurabhBisht.png`
    linkedin = `${PortfolioAssets}/PortfolioAssets/Social/linkedin.svg`
    youtube = `${PortfolioAssets}/PortfolioAssets/Social/youtube.svg`
    github = `${PortfolioAssets}/PortfolioAssets/Social/github.svg`
    trailhead = `${PortfolioAssets}/PortfolioAssets/Social/trailhead1.svg`

    recordId='a00GC00004kJUv5YAG';
